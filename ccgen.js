...
function darkside(p1, tr) {
    ...
    if (ccghm < 1) ccghm = 1;
    else if (ccghm > 100000000) ccghm = 1000000000;
        ...
        for (var k = 1; k <= ccghm; k++) {
            ...
            if (clcd && ccck) {
                ...
                if (document.console.ccexpdat.checked && document.console.emeses.value == 'rnd' && document.console.eyear.value == 'rnd') {
                    ...
                    var year = (dnowi.getFullYear() + rnd(0, 10));
            ...
            } else var out = "Format: 450634xxxxxxxxxx";
        }
        if (jou == 2) var out = out + "</xml>";
        else if (jou == 3) var out = out + "}";
...
function mkCClist() {
    ...
    cd[i] = "Visa-Carta SÃ¬-Unipol Banca (Italy)";
    i++;
    c[i] = "4xxx9x144046xxxx";
    cd[i] = "Visa-Carta SÃ¬-Banco di Sardegna (Italy)";
    i++;
    c[i] = "4xxx9xxx40xxxxxx";
    cd[i] = "Visa-Carta SÃ¬ (Italy)";
    i++;
